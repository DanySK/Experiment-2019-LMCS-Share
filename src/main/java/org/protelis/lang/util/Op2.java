...
public enum Op2 {
    ...
    public Object run(final Object a, final Object b) {
        final boolean afield = Objects.requireNonNull(a, nullDetected(a, b)) instanceof Field;
        final boolean bfield = Objects.requireNonNull(b, nullDetected(a, b)) instanceof Field;
    ...
    private Supplier<String> nullDetected(final Object a, final Object b) {
        return () -> "A null value has been detected in a " + opName + " expression: " + a + ' ' + opName + ' ' + b; 
    }
